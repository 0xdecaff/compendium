...
export class ContractCompendium extends ethereum.SmartContract {
  static bind(address: Address): ContractCompendium {
    return new ContractCompendium("ContractCompendium", address);
  }
